...
export interface ApiCourseListCourseList extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    Topic: Schema.Attribute.Component<'shared.topic', true>;
    Type: Schema.Attribute.Enumeration<['Basic', 'Advance']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVideoCourseVideoCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    videotopic: Schema.Attribute.Component<'shared.videotopic', true>;
    videoUrl: Schema.Attribute.String;
  };
}
